...
option = {
  ...
  series: [
    {
      name: '1年期',
      data: [3.65, 3.65, 3.65, 3.65, 3.65, 3.55, 3.55, 3.45, 3.45, 3.45, 3.45, 3.45, 3.45, 3.45, 3.45, 3.45, 3.45, 3.45, 3.35, 3.35, 3.35, 3.1, 3.1, 3.1, 3.1, 3.1, 3.1, 3.1, 3.0, 3.0, 3.0, 3.0],
      type: 'line',
      smooth: true
    },
    {
      name: '5年期以上',
      data: [4.3, 4.3, 4.3, 4.3, 4.3, 4.2, 4.2, 4.2, 4.2, 4.2, 4.2, 4.2, 4.2, 3.95, 3.95, 3.95, 3.95, 3.95, 3.85, 3.85, 3.85, 3.6, 3.6, 3.6, 3.6, 3.6, 3.6, 3.6, 3.5, 3.5, 3.5, 3.5],
      type: 'line',
      smooth: true
    }
  ]
...
邵东市（县级市）雅阁豪苑一套 150 平米的房子挂牌售价 68.8 万，每平米的房价 4587 元。一套 50 平米的房间，月租金 1000 元。那么，这套 50 平米的房子租金回报率 (12*1000) / (4587*50) = 5.2% 。这是根据安居客App页面上的数据得到的估计（不是实际谈的价），3-4线城市的租金回报率会高于 3% 。

...
bibliography: 
  - refer.bib
  - packages.bib
description: "介绍用于地理可视化的几种常用数据结构，比如 **sp** 包和**sf** 包提供的空间数据类型、数据操作和绘图方法。介绍地理可视化常用的展示形式，如瓦片图、围栏图、气泡图等，以及绘制过程中需要注意的制图规范问题。"
---
...
<figure>
<img src="/img/maps-in-r/sf-nc.png" class="full" alt="Figure 38: sf 数据可视化" /><figcaption aria-hidden="true">Figure 38: sf 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/leaflet-nc.png" class="full" alt="Figure 39: leaflet 数据可视化" /><figcaption aria-hidden="true">Figure 39: <strong>leaflet</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/latticeExtra-nc.png" class="full" alt="Figure 42: latticeExtra 数据可视化" /><figcaption aria-hidden="true">Figure 42: <strong>latticeExtra</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/lattice-volcano-shade.png" class="full" alt="Figure 43: Auckland Maunga Whau 火山三维地形图 \(10m\times 10m\)" /><figcaption aria-hidden="true">Figure 43: <a href="https://en.wikipedia.org/wiki/Maungawhau_/_Mount_Eden">Auckland Maunga Whau 火山</a>三维地形图 <code>\(10m\times 10m\)</code></figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/lattice-volcano-contour.png" class="full" alt="Figure 44: Auckland Maunga Whau 火山带等值线的三维地形图 \(10m\times 10m\)" /><figcaption aria-hidden="true">Figure 44: Auckland Maunga Whau 火山带等值线的三维地形图 <code>\(10m\times 10m\)</code></figcaption>
</figure>

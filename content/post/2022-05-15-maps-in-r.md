...
**rgeolocate** ([Keyes et al. 2021](#ref-rgeolocate)) 只包含 GeoLite2-Country.mmdb 数据
...
<figure>
<img src="/img/maps-in-r/quakes-leaflet.png" class="full" alt="Figure 24: leaflet 包使用 OpenStreetMap 地图" /><figcaption aria-hidden="true">Figure 24: <strong>leaflet</strong> 包使用 OpenStreetMap 地图</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/quakes-plotly.png" class="full" alt="Figure 25: plotly 包使用 Mapbox 地图" /><figcaption aria-hidden="true">Figure 25: <strong>plotly</strong> 包使用 Mapbox 地图</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/quakes-satellite.png" class="full" alt="Figure 26: plotly 包使用 Mapbox 卫星地图" /><figcaption aria-hidden="true">Figure 26: <strong>plotly</strong> 包使用 Mapbox 卫星地图</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sp-meuse.png" class="full" alt="Figure 27: sp 包绘图空间点数据" /><figcaption aria-hidden="true">Figure 27: <strong>sp</strong> 包绘图空间点数据</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/raster-grain.png" class="full" alt="Figure 28: terra 包绘制栅格数据" /><figcaption aria-hidden="true">Figure 28: <strong>terra</strong> 包绘制栅格数据</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sf-wheat.png" class="full" alt="Figure 29: 小麦产量空间分布图" /><figcaption aria-hidden="true">Figure 29: 小麦产量空间分布图</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sf-alaska.png" class="full" alt="Figure 30: sf 包绘制多边形数据" /><figcaption aria-hidden="true">Figure 30: <strong>sf</strong> 包绘制多边形数据</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sf-world.png" class="full" alt="Figure 31: 2014 年世界各国人均 GDP" /><figcaption aria-hidden="true">Figure 31: 2014 年世界各国人均 GDP</figcaption>
</figure>
...
下载和绘制中国地图数据，如图<a href="#fig:china-map">32</a>
...
<figure>
<img src="/img/maps-in-r/china-map.png" class="full" alt="Figure 32: 美国国家地理网站提供的中国地图数据" /><figcaption aria-hidden="true">Figure 32: 美国国家地理网站提供的中国地图数据</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/china-hchinamap.png" class="full" alt="Figure 33: 中国地图数据" /><figcaption aria-hidden="true">Figure 33: 中国地图数据</figcaption>
</figure>

### 交互地图

交互地图采用 **leaflet** 包绘制，采用 **leafletCN** 包汉化，并且提供合规的中国地图，核心函数是 `geojsonMap()`，它封装了 GeoJSON 格式的地图数据和绘图函数，更多定制参考`leaflet::leaflet()`，只要数据包含的一列区域名称和地图数据能映射上，就可以绘制出图<a href="#fig:china-leafletcn">34</a>，图中数据是随机生成的，调色板采用 `RdBu`，将连续的数据分段，每段对应一个色块。
...
<figure>
<img src="/img/maps-in-r/china-leafletcn.png" class="full" alt="Figure 34: 交互地图数据可视化" /><figcaption aria-hidden="true">Figure 34: 交互地图数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/china-linestring.png" class="full" alt="Figure 35: 静态地图数据" /><figcaption aria-hidden="true">Figure 35: 静态地图数据</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/china-province.png" class="full" alt="Figure 36: 静态地图数据" /><figcaption aria-hidden="true">Figure 36: 静态地图数据</figcaption>
</figure>
...
第三版的地图章节，如图 <a href="#fig:sf-nc">37</a>。在地图上绘制栅格图形，有个专业的制图术语 — Choropleth maps，翻译过来，大致叫填充地图、等值域图、瓦片图、围栏图、面量图、断层图等，可以非常直观地展示观测变量在地理区域内的变化情况。
...
<figure>
<img src="/img/maps-in-r/sf-nc.png" class="full" alt="Figure 37: sf 数据可视化" /><figcaption aria-hidden="true">Figure 37: sf 数据可视化</figcaption>
</figure>
...
**sp** 包提供的函数 `spplot()` 方法绘制类似的分面图，这其中借助了 **lattice** 包的绘图能力，效果如<a href="#fig:lattice-nc">38</a>所示。
...
<figure>
<img src="/img/maps-in-r/lattice-nc.png" class="full" alt="Figure 38: lattice 数据可视化" /><figcaption aria-hidden="true">Figure 38: <strong>lattice</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sp-nc.png" class="full" alt="Figure 39: sp 数据可视化" /><figcaption aria-hidden="true">Figure 39: <strong>sp</strong> 数据可视化</figcaption>
</figure>

## leaflet

而 leaflet 支持绘制交互式的图形，如图 <a href="#fig:leaflet-nc">40</a> 所示。
...
<figure>
<img src="/img/maps-in-r/leaflet-nc.png" class="full" alt="Figure 40: leaflet 数据可视化" /><figcaption aria-hidden="true">Figure 40: <strong>leaflet</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/latticeExtra-nc.png" class="full" alt="Figure 41: latticeExtra 数据可视化" /><figcaption aria-hidden="true">Figure 41: <strong>latticeExtra</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/lattice-volcano-shade.png" class="full" alt="Figure 42: Auckland Maunga Whau 火山三维地形图 \(10m\times 10m\)" /><figcaption aria-hidden="true">Figure 42: <a href="https://en.wikipedia.org/wiki/Maungawhau_/_Mount_Eden">Auckland Maunga Whau 火山</a>三维地形图 <code>\(10m\times 10m\)</code></figcaption>
</figure>

仅是图 <a href="#fig:lattice-volcano-shade">42</a> 就已经让 **ggplot2** 自愧不如了，更别说实现图<a href="#fig:lattice-volcano-contour">43</a>这样的组合图形，此例摘自 [Deepayan Sarkar](https://deepayan.github.io/) 的书《**lattice**: Multivariate Data Visualization with R》([Sarkar 2008](#ref-Sarkar2008))。

<figure>
<img src="/img/maps-in-r/lattice-volcano-contour.png" class="full" alt="Figure 43: Auckland Maunga Whau 火山带等值线的三维地形图 \(10m\times 10m\)" /><figcaption aria-hidden="true">Figure 43: Auckland Maunga Whau 火山带等值线的三维地形图 <code>\(10m\times 10m\)</code></figcaption>
</figure>

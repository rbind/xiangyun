...
**sp** 包提供的函数 `spplot()` 方法绘制类似的分面图，这其中借助了 **lattice** 包的绘图能力，效果如<a href="#fig:lattice-nc">49</a>所示。
...
<figure>
<img src="/img/maps-in-r/lattice-nc.png" class="full" alt="Figure 49: lattice 数据可视化" /><figcaption aria-hidden="true">Figure 49: <strong>lattice</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sp-nc.png" class="full" alt="Figure 50: sp 数据可视化" /><figcaption aria-hidden="true">Figure 50: <strong>sp</strong> 数据可视化</figcaption>
</figure>

## leaflet

而 **leaflet** 支持绘制交互式的图形，如图 <a href="#fig:leaflet-nc">51</a> 所示。稍微注意的是，需要先将数据映射到坐标参考系 EPSG:4326 上，而后 **leaflet** 会负责将数据转化映射到 EPSG:3857，详见[文档](https://rstudio.github.io/leaflet/projections.html)。
...
<figure>
<img src="/img/maps-in-r/leaflet-nc.png" class="full" alt="Figure 51: leaflet 数据可视化" /><figcaption aria-hidden="true">Figure 51: <strong>leaflet</strong> 数据可视化</figcaption>
</figure>

...
<figure>
<img src="/img/maps-in-r/raster-elevation.png" class="full" alt="Figure 18: raster 包绘制锡安国家公园地形" /><figcaption aria-hidden="true">Figure 18: <strong>raster</strong> 包绘制锡安国家公园地形</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sf-wheat.png" class="full" alt="Figure 19: 小麦产量空间分布图" /><figcaption aria-hidden="true">Figure 19: 小麦产量空间分布图</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sf-alaska.png" class="full" alt="Figure 20: sf 包绘制多边形数据" /><figcaption aria-hidden="true">Figure 20: <strong>sf</strong> 包绘制多边形数据</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/sf-world.png" class="full" alt="Figure 21: 2014 年世界各国人均 GDP" /><figcaption aria-hidden="true">Figure 21: 2014 年世界各国人均 GDP</figcaption>
</figure>
...
ggplot2 提供的几何图层 `geom_sf()` 是专门为 sf 数据对象准备的，`facet_wrap()` 和 `facet_grid()` 都可以用来实现分面，布局样式稍有不同，如图 <a href="#fig:sf-nc">22</a>。
...
<figure>
<img src="/img/maps-in-r/sf-nc.png" class="full" alt="Figure 22: sf 数据可视化" /><figcaption aria-hidden="true">Figure 22: sf 数据可视化</figcaption>
</figure>
...
**sp** 包提供的函数 `spplot()` 方法绘制类似的分面图，这其中借助了 **lattice** 包的绘图能力，效果如<a href="#fig:lattice-nc">23</a>所示。
...
<figure>
<img src="/img/maps-in-r/lattice-nc.png" class="full" alt="Figure 23: lattice 数据可视化" /><figcaption aria-hidden="true">Figure 23: <strong>lattice</strong> 数据可视化</figcaption>
</figure>
...
<figure>
<img src="/img/maps-in-r/lattice-volcano.png" class="full" alt="Figure 24: Auckland Maunga Whau 火山三维地形图 \(10m\times 10m\)。" /><figcaption aria-hidden="true">Figure 24: <a href="https://en.wikipedia.org/wiki/Maungawhau_/_Mount_Eden">Auckland Maunga Whau 火山</a>三维地形图 <code>\(10m\times 10m\)</code>。</figcaption>
</figure>

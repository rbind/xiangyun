...
math: true
description: "这是一道 2019 年的某公司笔试题，面试官要求用不少于 5 种统计模型来建模，在三天内完成并给一个展示。"
---

这是一道 2019 年的某公司笔试题，面试官要求用不少于 5 种统计模型来建模，在三天内完成并给一个展示。不过，本文仅给出探索分析和广义线性模型的结果，算是前一篇[广义线性模型和指数族](/2026/04/glm-family/)的应用。
...
入院疾病分类 3 相比于入院疾病分类 2、4 对应的疾病更加严重，病人才会更短时间决定住院。
入院目的 2、3 都是促使病人决定住院的因素。
入院病情 2 类似。
医生 4 相比于医生 3、2 ，可能是个专家号，病人住院的决策时间更短。

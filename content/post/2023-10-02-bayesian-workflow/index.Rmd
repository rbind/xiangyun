...
fit_rongelap_gaussian$summary(
  variables = c("lp__", "alpha", "sigma", "phi"),
...
## mu是均值向量，
## Sigma是协方差阵，需要是对称正定阵。
# https://www.math.pku.edu.cn/teachers/lidf/docs/statcomp/html/_statcompbook/rng-multi.html
...
# 1000 个样本点
x <- rng.mnorm(n = 1000, mu = c(3, 2), Sigma = rbind(c(4, 1), c(1, 1)))
# 样本协方差矩阵
var(t(x))

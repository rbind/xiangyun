...
- 2022-08-05 修改、交付
实际写作又修改计划
- 2022-08-01 完成 Pandoc's Markdown
- 2022-08-02 完成基础篇
- 2022-08-03 上午完成高级篇，涉及 Quarto beamer 制作
- 2022-08-03 下午、晚上完成忍者篇
- 2022-08-04 完成技巧与陷阱、本文小结
- 2022-08-05 PR 转正，投稿，邀请审稿人，
实际写作继续修改计划
- 8-3 完成高级篇、完成 Quarto 制作 beamer 幻灯片，填了数学符号与数学字体坑
- 8-4 继续填中文字体坑、Lua 外挂（Lua 外挂以简单的为例，找两个例子，自定义 block， rmarkdown 内置的一个 lua 脚本）
- 8-5 本文小结、全文打磨，文字修改，PR 转正
实际写作继续修改计划
- 8-3 完成高级篇、完成 Quarto 制作 beamer 幻灯片，填了数学符号与数学字体坑
- 8-4 继续填中文字体坑、Lua 外挂（Lua 外挂以简单的为例，找两个例子，自定义 block，rmarkdown 内置的一个 lua 脚本）、本文小结
- 8-5 全文打磨，文字修改，PR 转正，周知 yihui
-->
...
1.  功能方面：
    ...
    1. 添加变量 `lang:` 统一处理本土化语言，详见 (<https://quarto.org/docs/authoring/language.html>)。
...
1.  使用方式：
    ...
    1.  交叉引用的方式 ，如引用图片`\@ref(fig:quarto-beamer)` 变为 `@fig-quarto-beamer`，引用表格、公式与之类似，详见 (<https://quarto.org/docs/authoring/cross-references.html>)。

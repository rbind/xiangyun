...
1.  鼠标落在时间轴上，悬浮提示包含整个自定义 `e_tooltip()` 内容，这是有问题的，感谢 John Coene 提供[解决办法](https://github.com/JohnCoene/echarts4r/issues/433)。
...
::: sidebar
在世界银行的数据集里，俄罗斯联邦的国家名称记录为 Russian Federation，而在 **echarts4r** 包内置的[世界地图数据集](https://github.com/JohnCoene/echarts4r/blob/master/inst/htmlwidgets/lib/echarts-4.8.0/world.js)里，俄罗斯联邦的国家名称 Russia，要加上这个国家的数据，需要做一下数据转化，实际上，还不止俄罗斯。一个比较好的方式是用**国家代码**（如 [ISO3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3)）关联经济社会数据和地图数据。
:::

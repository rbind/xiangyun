# https://github.com/keithmcnulty/hans_rosling_bubble
...
# SP.DYN.LE00.IN 寿命 Life expectancy at birth, total (years)
# NY.GDP.PCAP.CD 国民生产总值
# SP.POP.TOTL 人口总数
dat = wbstats::wb(indicator = c("SP.DYN.LE00.IN", "NY.GDP.PCAP.CD", "SP.POP.TOTL"), 
